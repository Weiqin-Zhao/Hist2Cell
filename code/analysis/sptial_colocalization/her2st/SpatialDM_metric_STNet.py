...
for case in test_slides:
    ...
    save_path = "/data1/r20user3/shared_project/Hist2Cell/code/analysis/inference/her2st/her2st_epoch100_lr1e-4_densenet_onlycell_"+case+"_best_cell_all_abundance_average.pkl"
    pred_and_label = joblib.load(save_path)
    
    for slide in pred_and_label:
        # os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide))
        ...
        # df_label .to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "MoranR_Cell2location.csv"))
        ...
        # plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "MoranR_heatmap_Cell2location.png"))
        # plt.close()
        ...
        df_pred.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "MoranR_STNet.csv"))
        ...
        # plt.figure(figsize=(30, 30))
        # sns.heatmap(correlation_df, annot=True, fmt='.2f', linewidths=.5, annot_kws={"size": 12})
        # plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "MoranR_heatmap_Hist2Cell.png"))
        # plt.close()
        
        # common_df = df_label.head(200).merge(df_pred.head(200), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        # common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_in_top200pairs.csv"))
        # common_df = df_label.head(100).merge(df_pred.head(100), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        # common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_in_top100pairs.csv"))
        # common_df = df_label.head(50).merge(df_pred.head(50), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        # common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_in_top50pairs.csv"))
        ...
        # plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_pairs_in_top200.png"))
        # plt.close()
        # set1 = set(df_label.head(100)['pair'].values)
        # set2 = set(df_pred.head(100)['pair'].values)
        # venn = venn2([set1, set2], set_labels=('Cell2location', 'Hist2Cell'))
        # plt.title("Common cell type pairs in Cell2location and Hist2Cell")
        # plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_pairs_in_top100.png"))
        # plt.close()
        # set1 = set(df_label.head(50)['pair'].values)
        # set2 = set(df_pred.head(50)['pair'].values)
        # venn = venn2([set1, set2], set_labels=('Cell2location', 'Hist2Cell'))
        # plt.title("Common cell type pairs in Cell2location and Hist2Cell")
        # plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/her2st", case, slide, "common_pairs_in_top50.png"))
        # plt.close()
