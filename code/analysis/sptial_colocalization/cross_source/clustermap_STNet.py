...
for case in test_slides:
    ...
    for slide in pred_and_label:
        ...
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "MoranR_clustermap_STNet.png"))
        plt.close()