...
for case in test_slides:
    ...
    for slide in pred_and_label:
        ...
        df_label .to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "MoranR_Cell2location.csv"))
        ...
        df_pred.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "MoranR_Hist2Cell.csv"))
        
        common_df = df_label.head(200).merge(df_pred.head(200), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_in_top200pairs.csv"))
        common_df = df_label.head(100).merge(df_pred.head(100), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_in_top100pairs.csv"))
        common_df = df_label.head(50).merge(df_pred.head(50), on=['A', 'B'], suffixes=('_Cell2location', '_Hist2Cell'))
        common_df.to_csv(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_in_top50pairs.csv"))
        ...
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_pairs_in_top200.png"))
        plt.close()
        set1 = set(df_label.head(100)['pair'].values)
        set2 = set(df_pred.head(100)['pair'].values)
        venn = venn2([set1, set2], set_labels=('Cell2location', 'Hist2Cell'))
        plt.title("Common cell type pairs in Cell2location and Hist2Cell")
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_pairs_in_top100.png"))
        plt.close()
        set1 = set(df_label.head(50)['pair'].values)
        set2 = set(df_pred.head(50)['pair'].values)
        venn = venn2([set1, set2], set_labels=('Cell2location', 'Hist2Cell'))
        plt.title("Common cell type pairs in Cell2location and Hist2Cell")
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/sptial_colocalization/cross_source", case, slide, "common_pairs_in_top50.png"))
        plt.close()
