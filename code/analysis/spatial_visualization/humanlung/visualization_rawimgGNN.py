...
for case in test_slides:
    ...
    for slide in pred_and_label:
        ...
        for i in range(39):
            ...
            plt.axis('equal')
            plt.axis('off')
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell abundance", cell_names[i]+"_rawimgGNN.png"))
            plt.close()
            # break
        ...
        for i in range(39):
            ...
            plt.axis('equal')
            plt.axis('off')
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion", cell_names[i]+"_rawimgGNN.png"))
            plt.close()
            # break  