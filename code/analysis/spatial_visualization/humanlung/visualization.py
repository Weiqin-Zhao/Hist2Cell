...
#     os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case))
...
#         os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide))
...
#         os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion"))
#         counts = pred_ratio
#         coordinates = pred_and_label[slide]['coords']
#         image = cv2.imread("/data1/r20user3/shared_project/Hist2Cell/data/human_lung_cell2location/"+slide+"/"+slide+".jpg")
...
#                 fig.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion", cell_names[i]+"_Hist2cell.png"))
#                 plt.close(fig)
...
#                 fig = img[0].figure  # Get the figure associated with the axes object
#                 fig.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion", cell_names[i]+"_Cell2location.png"))
#                 plt.close(fig)  
            
        
#         os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell abundance"))
...
#                 fig = img[0].figure  # Get the figure associated with the axes object
#                 fig.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell abundance", cell_names[i]+"_Hist2cell.png"))
#                 plt.close(fig)
...
#                 fig = img[0].figure  # Get the figure associated with the axes object
#                 fig.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell abundance", cell_names[i]+"_Cell2location.png"))
#                 plt.close(fig)   
...
for case in test_slides:
    ...
    for slide in pred_and_label:
        ...
        for i in range(39):
            ...
            plt.axis('equal')
            plt.axis('off')
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell abundance", cell_names[i]+"_Hist2Cell.png"))
            plt.close()
            # break
        ...
        for i in range(39):
            ...
            plt.axis('equal')
            plt.axis('off')
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion", cell_names[i]+"_Cell2location.png"))
            plt.close()
            # break        
        ...
        for i in range(39):
            ...
            plt.axis('equal')
            plt.axis('off')
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung", case, slide, "cell proportion", cell_names[i]+"_Hist2Cell.png"))
            plt.close()
            # break  