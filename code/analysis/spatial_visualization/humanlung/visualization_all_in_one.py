...
def process_cell_type(i, coordinates, cell2location_count2, hist2cell_counts, stnet_counts, X, Y, case, slide, cell_names):
    ...
    plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung/all_in_one", case, slide, cell_names[i]+".png"), bbox_inches='tight')
    plt.close()
...
for case in test_slides:
    ...
    for slide in pred_and_label:
        os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/spatial_visualization/humanlung/all_in_one", case, slide))
        ...
        Parallel(n_jobs=n_threads)(delayed(process_cell_type)(i, coordinates, cell2location_count2, hist2cell_counts, stnet_counts, X, Y, case, slide, cell_names) for i in range(80))
