...
for case in test_slides:
    os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case))
    ...
    for slide in pred_and_label:
        os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, slide))
        ...
        os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, slide, "cell proportion"))
        for i in range(39):
            ...
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, slide, "cell proportion", cell_names[i]+".png"))
            plt.close()
            
        os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, slide, "cell abundance"))
        for i in range(39):
            plt.figure(figsize=(4, 4))
            ...
            plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, slide, "cell abundance", cell_names[i]+".png"))
            plt.close()
    ...
    os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, "cell proportion"))
    for i in range(39):
        plt.figure(figsize=(4, 4))
        x = pred_ratio[:,[i]]
        x = np.expand_dims(x, axis=0)
        ...
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, "cell proportion", cell_names[i]+".png"))
        plt.close()
        
    os.mkdir(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, "cell abundance"))
    for i in range(39):
        plt.figure(figsize=(4, 4))
        x = case_pred[:,[i]]
        x = np.expand_dims(x, axis=0)
        ...
        plt.savefig(os.path.join("/data1/r20user3/shared_project/Hist2Cell/code/analysis/pearson_analysis/pearson_scatter_plot_each_case_cross_source", case, "cell abundance", cell_names[i]+".png"))
        plt.close()